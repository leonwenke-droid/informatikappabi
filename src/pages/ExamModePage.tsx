...
export function ExamModePage() {
  ...
  const ok = examModeDefaultUnlocked(PATH_STAGES, unitProgress, 7) || settings.examModeUnlocked || settings.skippedExamGate;
      ...
      <div>
        ...
        <Card className="p-6 max-w-lg">
          <p className="text-slate-300 mb-4">
            Der Klausurmodus ist erst sinnvoll, wenn die Grundlagen sitzen. Du kannst ihn freischalten, wenn du mindestens die ersten 7 Etappen bearbeitet hast — oder bewusst überspringen.
          </p>
