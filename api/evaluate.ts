/**
 * Vercel Serverless Function + export für lokalen Hono-Server.
 * Alles in einer Datei, damit Vercel kein api/lib/*-Modul ausliefern muss (ESM/Bundle).
 * OPENAI_API_KEY / OPENAI_MODEL in Vercel → Environment Variables.
 */
...
type EvaluateFailureBody = { error: string; detail?: string };

type EvaluateCoreResult =
...
/** Für lokalen `server/index.ts` — gleiche Implementierung wie in dieser Datei. */
